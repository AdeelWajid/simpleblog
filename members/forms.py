...
class PasswordChangingForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(max_length=100, widget=forms.PasswordInput(attrs={'class': 'form-control mb-2', 'type': 'password'}))
    new_password2 = forms.CharField(max_length=100, widget=forms.PasswordInput(attrs={'class': 'form-control mb-2', 'type': 'password'}))
